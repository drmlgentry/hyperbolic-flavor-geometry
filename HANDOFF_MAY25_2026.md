# HFG Research Handoff â€” May 25, 2026
...
Specifically:
  r â‰¡ 1,3 mod 4:  |WRT|^2 = 13/r = L_6/r
  r â‰¡ 0 mod 4:    |WRT|^2 = 25/r
  r â‰¡ 2 mod 4:    |WRT|^2 = 1/r
...
### 3. X_0(11) Bridge (SSRN 6815721 â€” already submitted)
...
parameters â€” a different object from the invariant trace field.
...
### 5. Quaternion Algebra of M_PMNS (from Reid table)
  ...
  - QA = M_2(k) â€” the matrix algebra, not a division algebra
...
- PTEP T06112 (Unified HFG, Paper) â€” Posted May 23
- PTEP T06113 (CP phase, Letter) â€” Posted May 23
- SSRN 6815721 (X_0(11) bridge) â€” Posted May 23

### New papers drafted (not yet submitted)
- gentry-wrt-x011.tex/.pdf â€” WRT Slope Norm Theorem (8 pages, CLEAN)
...
- /mnt/user-data/outputs/gentry-wrt-x011.pdf â€” WRT theorem paper
- /mnt/user-data/outputs/gentry-wrt-x011.tex â€” WRT theorem source
- /mnt/user-data/outputs/gentry-x011-bridge-v2.pdf â€” X_0(11) bridge (corrected)
- /mnt/user-data/outputs/x011_bridge_diagram.pdf â€” Bridge diagram figure
- /mnt/user-data/outputs/x011_farey_eigenvalues.pdf â€” Farey+eigenvalue figure

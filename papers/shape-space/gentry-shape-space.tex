...
\]
where $\|[X,Y]\|^2 = \tr([X,Y]^2) \cdot (-1)$ and norms are taken
...
The flat $F_0$ is isometric to $(\R^{r-1}, \tr(\cdot\,\cdot))$,
...
Since maximal abelian subspaces of $\mathfrak{p}$
are uniquely determined by their tangent spaces,
the corresponding flats coincide globally.
\end{proof}

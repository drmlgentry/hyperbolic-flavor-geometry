...
\subsection{Reproducibility and artifacts}
  The LatticeFit software is archived at \url{https://doi.org/10.5281/zenodo.19225731}~\cite{Gentry:LatticeFit}.
...
($\mathrm{CS}=1/2$, exact, arithmetic manifold hallmark) connects

...
signature. The count $3{,}648$ is not obtained by treating the four
field choices independently: exact enumeration over the $13$
ramification-disjoint $C_2$-pairs shows that admissible $S_4$ and $S_3$
counts vary with the accumulated ramification support; the
accompanying reproducibility computation evaluates the resulting
finite compatibility sum exactly.

...
Both manifolds share $H_1 = \Zfive$, exhibiting a correlation between
odd-prime torsion in the first homology group and successful geometric
fits for three-generation flavor structure. The diagonal $A$-factor is conjectured to encode CP-violating phases.
All computations are reproducible via
...
All scan data and analysis scripts are publicly available at \url{https://github.com/drmlgentry/hyperbolic-flavor-scan}.

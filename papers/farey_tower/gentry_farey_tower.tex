...
Third, we discover and verify computationally (for $n = 1,\ldots,10$)
the following:
...
\medskip\noindent\textbf{Keywords:} hyperbolic 3-manifolds; Dehn surgery; Farey tower; Meyerhoff manifold; arithmetic hyperbolic manifolds; homology covering spaces; quadratic prime formula; SnapPy
...
This work arose from the Hyperbolic Flavor Geometry (HFG) program
...
The cusped manifold $m006$ (trace field the unique cubic field
of discriminant $-59$, defined by $x^3+2x-1$; see also
\cite{GentryArith2026}) admits an analogous Farey tower
with $H_1$-preserving slopes, and the corresponding cover prime
formula is a quadratic function of the slope parameter.
\end{conjecture}
...
\bibitem{GentryArith2026}
M.~L. Gentry,
WRT Invariants, the $X_0(11)$ Arithmetic Bridge, and the Slope Norm
Theorem for Arithmetic Hyperbolic 3-Manifolds,
SSRN 7099798 (2026).

\end{thebibliography}

\end{document}
submitted to \emph{Research in Mathematics} (2026);

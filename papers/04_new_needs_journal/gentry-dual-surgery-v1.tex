...
\begin{remark}
$D_6$ (order 12) is in fact isomorphic to $S_3\times\Z/2$: writing
$D_6=\mathrm{Dih}(6)$, the general splitting
$\mathrm{Dih}(2n)\cong\mathrm{Dih}(n)\times\Z/2$ holds whenever $n$
is even, and $n=6$ is even here, giving
$\mathrm{Dih}(6)\cong\mathrm{Dih}(3)\times\Z/2=S_3\times\Z/2$
(confirmed directly: both groups have GAP small-group id
$[12,4]$, and an explicit isomorphism exists). This result
therefore \emph{does} extend the Pati--Salam correspondence of
...
Galois closure $D_6$ (dihedral, order 12). $D_6$ is in fact
isomorphic to $S_3\times\Z/2\cong\Weyl(\SU(3))\times\Z/2$ (the
splitting $\mathrm{Dih}(2n)\cong\mathrm{Dih}(n)\times\Z/2$ for even
$n$, here $n=6$; confirmed directly, both groups share GAP
small-group id $[12,4]$). This result therefore \emph{does} extend

...
from Cusp Arithmetic of Hyperbolic Flavor Manifolds}
...
compact hyperbolic 3-manifolds of the Hyperbolic Flavor Geometry (HFG)
program: $M_{\mathrm{PMNS}}=\mfld{m003}(-2,3)$ (the Meyerhoff manifold)
...
In the Hyperbolic Flavor Geometry (HFG) program~\cite{GentryUnified},
two compact hyperbolic 3-manifolds reproduce the Standard Model flavor
...
flavor manifold is determined by the gauge symmetry of the

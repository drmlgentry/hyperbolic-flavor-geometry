...
\title{Galois Groups of Cusp Shapes of Hyperbolic Flavor Manifolds\\
...
\begin{abstract}
Three hyperbolic 3-manifolds arising in the Hyperbolic Flavor
Geometry program have cusp shapes whose minimal polynomials
...
the Meyerhoff manifold~\cite{GMM} -- the unique
minimum-volume closed hyperbolic 3-manifold with
first homology $H_1=\Z/5$, and the second-smallest
known closed hyperbolic 3-manifold by volume globally.

...
\subjclass[2020]{Primary 57K32; Secondary 37C35}

\keywords{hyperbolic 3-manifolds, geodesic length spectrum, orbit growth,
homology classes, spectral floor, complex length}
...
program~\cite{GentryUnified} as geometric models for

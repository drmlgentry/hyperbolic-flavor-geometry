...
on $\MCKM$ gives $M_Z/M_W = 1.1348$ ($0.025\%$ from PDG);
(iii) the reactor angle is $\theta_{13}^\nu = 180\degr -
\varphi(\mathrm{BaBBBBB}) = 8.546\degr$ on $\MCKM$ ($0.007\%$ from PDG).
...
\begin{equation}
  ...
  \label{eq:mzmw}
\end{equation}
PDG~2024: $M_Z/M_W = 1.13452$; discrepancy $0.025\%$.
\end{observation}
...
$M_Z/M_W$ & $1.13452$ & BBBBB/baa (ratio) & $\MCKM$ & $1.1348$ & $0.025\%$ \\
$\theta_{13}^\nu$ & $8.54\degr$ & BaBBBBB & $\MCKM$ & $8.546\degr$ & $0.007\%$ \\
\midrule
...
the leptonic CP phase ($0.55\%$), the $M_Z/M_W$ ratio ($0.025\%$),

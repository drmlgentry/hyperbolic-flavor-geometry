...
\item Chern--Simons invariant of the cusped ancestor: $\mathrm{CS}(\texttt{m003})=\tfrac{1}{4}$ (exact, $s(2,1)=s(-2,3)_{\mathrm{cusp}}=0$), confirming arithmeticity of \texttt{m003}; note $\mathrm{CS}(M_{\mathrm{PMNS}})\neq\tfrac{1}{4}$ since $s(-2,3)=\tfrac{1}{18}\neq 0$.
\end{itemize}

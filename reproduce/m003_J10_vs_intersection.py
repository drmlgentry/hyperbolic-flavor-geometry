...
Exact comparison of the word-length-graded collision ideals
    ...
    J_L = < Delta_{w,v} : T_w = T_v on X_0(m003), Delta_{w,v} != 0, |w|,|v| <= L >

against K = P_0 cap I(N),  P_0 = <xz+1, x^2+y-1>,  I(N) = <x-z, y-2>.
...
for p in GB_K.exprs:
    _, r1 = sp.reduced(p, [g1, g2], z, y, x, order="lex")
